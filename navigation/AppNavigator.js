...
import BlogHomeScreen       from '../app/screens/blog/BlogHomeScreen';
import BlogDetailScreen     from '../app/screens/blog/BlogDetailScreen';
const Stack = createNativeStackNavigator();
const Tab   = createBottomTabNavigator();
function MainTabs() {
  return (
    <Tab.Navigator screenOptions={{ headerShown:false, tabBarActiveTintColor:'#2c3e50', tabBarInactiveTintColor:'#95a5a6', tabBarStyle:{paddingBottom:6,height:60} }}>
      <Tab.Screen name='Revise' component={RevisionHomeScreen} options={{tabBarLabel:'Revise'}}/>
      <Tab.Screen name='News'   component={BlogHomeScreen}     options={{tabBarLabel:'News'}}/>
      <Tab.Screen name='Shop'   component={AffiliateScreen}    options={{tabBarLabel:'Shop'}}/>
      <Tab.Screen name='About'  component={DisclaimerScreen}   options={{tabBarLabel:'About'}}/>
    </Tab.Navigator>
  );
}
